         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
             <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900 dark:to-indigo-900 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
               ...
               <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Research Support</h3>
             ...
             <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900 dark:to-emerald-900 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
               ...
               <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Teaching Resources</h3>
               <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
       ...
       <section className="py-20 bg-gray-50 dark:bg-gray-800">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="text-center mb-16">
             ...
             <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">Comprehensive cloud solutions tailored for academic excellence</p>
           </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
             <div className="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
               ...
               <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">High-performance computing clusters</h3>
             </div>
             <div className="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
               ...
               <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Cloud storage and data management</h3>
             </div>
             <div className="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
               ...
               <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Machine learning and AI platforms</h3>
             </div>
              <div className="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Research collaboration tools</h3>
              </div>
              <div className="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
               ...
               <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Secure data analytics solutions</h3>
             </div>
             <div className="bg-white dark:bg-gray-700 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
               ...
               <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">24/7 Support & Training</h3>
             </div>
          </div>
        </div>
      </section>
