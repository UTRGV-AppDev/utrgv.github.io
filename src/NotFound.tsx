...
function NotFound() {
  ...
  useEffect(() => {
    // Focus the h1 heading on mount for better keyboard navigation
  ...
  return (
    <>
      <Helmet>
        <title>404 - Page Not Found | UTRGV AI Agents</title>
        <meta 
          name="description" 
          content="The page you're looking for doesn't exist. Return to UTRGV AI Agents home to explore our AI agent showcase platform." 
        />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-orange-50 to-red-50 dark:from-gray-900 dark:via-gray-800 dark:to-red-950">
        ...
        <main className="flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
          <article className="max-w-4xl w-full text-center">
            {/* Animated AI Icons */}
            <div className="relative mb-8 h-48" aria-hidden="true">
            ...
            <div className="mb-8">
              <h1 
                ref={headingRef}
                tabIndex={-1}
                className="text-9xl md:text-[12rem] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-utrgv-orange-600 via-red-600 to-utrgv-orange-700 dark:from-utrgv-orange-400 dark:via-red-400 dark:to-utrgv-orange-500 leading-none focus:outline-none focus:ring-2 focus:ring-utrgv-orange-500 focus:ring-offset-4 rounded"
              >
                404
              </h1>
            </div>
            ...
            {/* Error Message */}
            <section aria-labelledby="error-heading" className="mb-8">
              <h2 id="error-heading" className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">
                Agent Not Found
              </h2>
            ...
            <section aria-labelledby="error-details-heading" className="mb-12">
              <h3 id="error-details-heading" className="sr-only">Error Details</h3>
            ...
            {/* Action Buttons */}
            <nav aria-label="Error page navigation" className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                to="/"
            ...
            {/* Fun Tech Message */}
            <aside aria-label="Technical error message" className="mt-12 text-sm text-gray-500 dark:text-gray-500 font-mono">
